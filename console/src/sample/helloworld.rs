...
use rust_gears_sdk::bcossdkutil::liteutils::datetime_str;
...
pub fn demo_deploy_helloworld(bcossdk: &mut Bcos2Client) -> Result<String, KissError> {
    ...
    console::utils::display_transaction_receipt(&receipt, &Option::None, &bcossdk.config);
...
pub fn demo(configfile: &str) {
    ...
    let recepitresult = bcossdk.try_getTransactionReceipt(txhash, 3, false);
    console::utils::display_transaction_receipt(
