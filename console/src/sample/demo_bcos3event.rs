...
use rust_gears_sdk::bcos3sdk::bcos3client::Bcos3Client;
use rust_gears_sdk::bcos3sdk::bcos3sdkfuture::Bcos3SDKFuture;
use rust_gears_sdk::bcos3sdk::bcos3sdkresponse::{Bcos3SDKResponse, bcos_sdk_c_struct_response};
use rust_gears_sdk::bcos3sdk::bcos3sdkwrapper::bcos3sdk_def::*;
use rust_gears_sdk::bcos3sdk::bcos3sdkwrapper::{BCOS3SDK_CALLBACK_FUNC, EventSubParam};
use rust_gears_sdk::bcossdkutil::commonhash::CommonHash;
...
use rust_gears_sdk::bcossdkutil::liteutils::{datetime_str, json_str};
use rust_gears_sdk::str2p;

use crate::common::Cli;
use crate::console::utils::display_receipt_logs;
...
pub extern "C" fn demo_bcos3_event_callback(resp: *const bcos_sdk_c_struct_response) {
    ...
    unsafe {
        ...
        G_COUNTER.fetch_add(1, Ordering::SeqCst);
        println!("Counter: {}", G_COUNTER.load(Ordering::SeqCst));
