...
use bcos3sdk_def::bcos_sdk_is_last_opr_success;
...
use crate::bcos3sdk::bcos3client::Bcos3Client;
...
pub mod bcos3sdk_def {
    ...
    extern "C" {
         ...
         * @return void
         */
        pub fn bcos_sdk_create_signed_transaction_ver_extra_data(
            key_pair: *const c_void,
            group_id: *const c_char,
            chain_id: *const c_char,
            to: *const c_char,
...
pub unsafe fn init_bcos3sdk_lib(sdk_cfgfile: &str) -> *const c_void {
    unsafe {
        ...
        if bcos_sdk_is_last_opr_success() == 0 {
        ...
        tracing::info!(target: "bcossdk", "success: sdk create success!");
